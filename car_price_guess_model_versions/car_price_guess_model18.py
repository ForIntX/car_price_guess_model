...
if not df.empty:
    ...
    # DÜZELTME: Grafik fonksiyonu artık 'tahmin_cizgisi' parametresi almıyor
    def guncel_grafik_ciz():
        ...
        # DÜZELTME: Tahmin çizgisini (ax.axhline) çizen 'if' bloğu kaldırıldı.
    ...
    def tahmin_yap():
        ...
        # DÜZELTME: Grafik fonksiyonu artık parametresiz çağrılıyor
        guncel_grafik_ciz()
